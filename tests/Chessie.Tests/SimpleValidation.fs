...
let ``should find empty name``() = 
    { Name = ""
      EMail = "" }
    |> combinedValidation
    |> shouldEqual (RopResult<_,_>.Bad [ "Name must not be blank" ])
...
let ``should find empty mail``() = 
    { Name = "Scott"
      EMail = "" }
    |> combinedValidation
    |> shouldEqual (RopResult<_,_>.Bad [ "Email must not be blank" ])
...
let ``should find long name``() = 
    { Name = "ScottScottScottScottScottScottScottScottScottScottScottScottScottScottScottScottScottScottScott"
      EMail = "" }
    |> combinedValidation
    |> shouldEqual (RopResult<_,_>.Bad [ "Name must not be longer than 50 chars" ])
